...
public class OnryonoShogunEntity extends Monster {
	...
	public OnryonoShogunEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SteelandsakuraModEntities.ONRYONO_SHOGUN.get(), world);
	}

	public OnryonoShogunEntity(EntityType<OnryonoShogunEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 11;
		setNoAi(false);
