...
import net.astralvixen.steelandsakura.procedures.RoninEntityIsHurtProcedure;
import net.astralvixen.steelandsakura.procedures.RoninEntityDiesProcedure;
...
public class RoninEntity extends Monster {
	...
	public RoninEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SteelandsakuraModEntities.RONIN.get(), world);
	}
	...
	public RoninEntity(EntityType<RoninEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(SteelandsakuraModItems.SHADOW_KATANA.get()));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, AoiSamuraiEntity.class, false, false));
		this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, MidoriSamuraiEntity.class, false, false));
		this.targetSelector.addGoal(12, new NearestAttackableTargetGoal(this, FrostOniEntity.class, false, false));
		this.targetSelector.addGoal(13, new NearestAttackableTargetGoal(this, OniEntity.class, false, false));
		this.targetSelector.addGoal(14, new NearestAttackableTargetGoal(this, EndOniEntity.class, false, false));
		this.targetSelector.addGoal(15, new NearestAttackableTargetGoal(this, AkaiSamuraiEntity.class, false, false));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(SteelandsakuraModItems.YUGEN_SEAL_PIECE.get()));
	}
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		RoninEntityIsHurtProcedure.execute(world, x, y, z, entity, sourceentity);
	...
	public void die(DamageSource source) {
		super.die(source);
		RoninEntityDiesProcedure.execute(this);
	}
