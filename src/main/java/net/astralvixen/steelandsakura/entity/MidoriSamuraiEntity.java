...
public class MidoriSamuraiEntity extends PathfinderMob {
	public MidoriSamuraiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SteelandsakuraModEntities.MIDORI_SAMURAI.get(), world);
	}

	public MidoriSamuraiEntity(EntityType<MidoriSamuraiEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(SteelandsakuraModItems.MIDORINO_SEISHIN.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(SteelandsakuraModEntities.MIDORI_SAMURAI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getBlockState(pos.below()).is(BlockTags.ANIMALS_SPAWNABLE_ON) && world.getRawBrightness(pos, 0) > 8));
		DungeonHooks.addDungeonMob(SteelandsakuraModEntities.MIDORI_SAMURAI.get(), 180);
	}
