...
public class EndOniEntity extends Monster {
	public EndOniEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SteelandsakuraModEntities.END_ONI.get(), world);
	}

	public EndOniEntity(EntityType<EndOniEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(SteelandsakuraModEntities.END_ONI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
