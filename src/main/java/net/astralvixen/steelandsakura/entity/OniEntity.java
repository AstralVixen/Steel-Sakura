...
public class OniEntity extends Monster {
	public OniEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SteelandsakuraModEntities.ONI.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(SteelandsakuraModEntities.ONI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
