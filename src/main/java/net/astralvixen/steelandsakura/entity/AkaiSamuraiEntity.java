...
public class AkaiSamuraiEntity extends PathfinderMob {
	public AkaiSamuraiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SteelandsakuraModEntities.AKAI_SAMURAI.get(), world);
	}

	public AkaiSamuraiEntity(EntityType<AkaiSamuraiEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(SteelandsakuraModItems.SHINKUNO_HONO.get()));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(13, new NearestAttackableTargetGoal(this, FrostOniEntity.class, false, false));
		this.targetSelector.addGoal(14, new NearestAttackableTargetGoal(this, OniEntity.class, false, false));
	...
	public static void init() {
		SpawnPlacements.register(SteelandsakuraModEntities.AKAI_SAMURAI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getBlockState(pos.below()).is(BlockTags.ANIMALS_SPAWNABLE_ON) && world.getRawBrightness(pos, 0) > 8));
		DungeonHooks.addDungeonMob(SteelandsakuraModEntities.AKAI_SAMURAI.get(), 180);
	}
