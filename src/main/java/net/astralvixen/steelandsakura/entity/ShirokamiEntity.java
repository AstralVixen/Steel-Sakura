...
public class ShirokamiEntity extends Monster {
	...
	public ShirokamiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SteelandsakuraModEntities.SHIROKAMI.get(), world);
	}

	public ShirokamiEntity(EntityType<ShirokamiEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 11;
		setNoAi(false);
