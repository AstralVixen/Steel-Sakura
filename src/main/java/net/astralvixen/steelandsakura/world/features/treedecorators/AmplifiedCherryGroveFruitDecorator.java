...
package net.astralvixen.steelandsakura.world.features.treedecorators;
...
public class AmplifiedCherryGroveFruitDecorator extends CocoaDecorator {
	public static Codec<AmplifiedCherryGroveFruitDecorator> CODEC = Codec.unit(AmplifiedCherryGroveFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("amplified_cherry_grove_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public AmplifiedCherryGroveFruitDecorator() {
		super(0.2f);
	}
