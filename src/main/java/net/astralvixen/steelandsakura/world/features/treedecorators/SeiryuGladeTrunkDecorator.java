...
public class SeiryuGladeTrunkDecorator extends TrunkVineDecorator {
	public static Codec<SeiryuGladeTrunkDecorator> CODEC = Codec.unit(SeiryuGladeTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("seiryu_glade_tree_trunk_decorator", DECORATOR_TYPE));
	}
