...
public class AmplifiedCherryGroveLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(AmplifiedCherryGroveLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("amplified_cherry_grove_tree_leave_decorator", DECORATOR_TYPE));
	}

	public AmplifiedCherryGroveLeaveDecorator() {
		super(0.25f);
	}
